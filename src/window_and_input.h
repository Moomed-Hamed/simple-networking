...
void window_init(Window* window, uint screen_width, uint screen_height, const char* window_name = "window")
{
	window->screen_width  = screen_width;
	window->screen_height = screen_height;

	if (!glfwInit()) { WINDOW_ERROR("COULD NOT INIT GLFW"); stop; return; }
...
void game_window_update()
{
	glfwPollEvents();
}
void game_window_close()
{
	glfwTerminate();
}
...
void mouse_update(Mouse* mouse, Window window)
{
...
void keyboard_update(Keyboard* keyboard, Window window)
{
